...
<section>
   ...
   @csrf <!---CSRF protection -->
        <div class="form-group-eventfirst">
            ...
            <input type="text" name="title" class="form-control1" id="inputEventName" placeholder="Event Name" >
    ...
    <div class="form-group-eventform">
            ...
            <textarea name="description_long" class="inputEventDescLong" rows="10" cols="60"  placeholder="Enter a long description for your event here..."></textarea>
    ...
    <div class="form-group-eventform">
            ...
            <textarea name="description_short" class="inputEventDescShort" rows="10" cols="60"  placeholder="Enter a short description for your event here..."></textarea>
    ...
    <div class="form-group-eventform">
            ...
            <input type="time" name="time" class="form-control" id="inputEventTime" placeholder="Time" >
    ...
    <div class="form-group-eventform">
            ...
            <input type="text" name="loc_string" class="form-control" id="inputEventLocString" placeholder="Location" >
    ...
    <div class="form-group-eventform">
            ...
            <input type="number" name="lat" class="form-control" id="inputEventLat"  placeholder="Latitude"   >
    ...
    <div class="form-group-eventform">
            ...
            <input type="number" name="long" class="form-control" id="inputEventLong" placeholder="Longitude" >
